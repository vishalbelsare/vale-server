...
you'll likely experience worse performance with DITA files compared to other formats \(including plain XML, discussed below\).
:::
...
In order for Vale to understand your XML, you need to provide a version 1.0 XSL Transformation
\(XSLT\) for converting to HTML:
