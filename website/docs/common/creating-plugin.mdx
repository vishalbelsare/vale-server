...
Your extension should call the Vale server _[/vale_ endpoint](https://docs.errata.ai/api/index.html#/Linting%20and%20Suggestions/LintText), which the user of your plugin needs to have installed.
...
<!-- The VSCode extension does something similar, creating a [`postFile`](https://github.com/errata-ai/vale-vscode/blob/78cd80ff5bcc043f51aa22126997c4e86e5b13fd/src/features/vsUtils.ts#L212) method that handles creating the request and response to the endpoint, [that the extension calls](https://github.com/errata-ai/vale-vscode/blob/78cd80ff5bcc043f51aa22126997c4e86e5b13fd/src/features/vsProvider.ts#L47) when needed. -->
