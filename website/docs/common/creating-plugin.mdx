...
Your extension should call the Vale server _/file_ endpoint, which the user of your plugin needs to have installed.

_<http://localhost:7777/file>_ with a `file` and `path` query
