      ...
      <tr align="center">
         <td>
            <a href="clients/atom">
              <img
               alt="Atom's logo."
               src={useBaseUrl('img/logos/apps/Atom.png')}
               height="72"/>
            </a>
         </td>
         <td>
            <a href="clients/chrome">
              <img
               ...
               src={useBaseUrl('img/logos/apps/chrome.png')}
               height="64"/>
            </a>
         </td>
         <td>
            <a href="clients/google-docs">
              <img
               ...
               src={useBaseUrl('img/logos/apps/gdocs.png')}
               height="64"/>
            </a>
         </td>
         <td align="center">
            <a href="clients/sublime-text">
              <img
               ...
               src={useBaseUrl('img/logos/apps/sublime.png')}
               height="64"/>
            </a>
         </td>
         <td align="center">
            <a href="clients/vscode">
              <img
               ...
               src={useBaseUrl('img/logos/apps/code.png')}
               height="64"/>
            </a>
         </td>
      </tr>
